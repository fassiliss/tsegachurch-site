...
export default function Header() {
    ...
    // 🔹 Track scroll position to switch header style
    const [isScrolled, setIsScrolled] = useState(false);

    useEffect(() => {
        const handleScroll = () => {
            setIsScrolled(window.scrollY > 50); // after 50px, switch style
        };

        // run once in case user is not at top
        handleScroll();
    ...
    return (
        <>
            {/* 🔹 Use isScrolled to toggle extra class */}
            <header
                ...
                {navOpen && (
                    <div
                        ...
                        style={{
                            ...
                            bottom: 0,
                            background:
                                "linear-gradient(135deg, var(--bg-color) 0%, rgba(100, 50, 200, 0.05) 100%)",
                            zIndex: 999,
                            overflowY: "auto",
                            padding: "30px 20px",
                        ...
                        <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                            ...
                            <li style={{ marginBottom: "8px" }}>
                                <Link href="/members/register">
                                    ...
                                    >
                                        <i
                                            className="fas fa-user-plus me-3"
                                            style={{ fontSize: "20px", width: "24px" }}
                                        ></i>
                                        <span>Members</span>
                                    </a>
                                        ...
                                        {[
                                            ...
                                            >
                                                <Link href={ministry.href}>
                                                    ...
                                                    >
                                                        <i
                                                            className={`fas ${ministry.icon} me-3`}
                                                            style={{
                                                                fontSize: "16px",
                                                                width: "20px",
                                                                opacity: 0.7,
            ...
            {/* spacer – you can delete this IF your hero/first section has enough top padding */}
