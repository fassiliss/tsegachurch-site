...
export default function HomeEventsSection() {
    ...
    return (
        <section style={{ padding: "80px 0", background: "var(--bg-secondary, #f9f9f9)" }}>
            <div className="theme_container">
                <div style={{ textAlign: "center", marginBottom: "60px" }}>
                    ...
                    <h2 style={{ fontSize: "2.5rem", marginBottom: "15px", color: "var(--text-color, #333)" }}>
                        Upcoming Events
                    </h2>
                    <p style={{ fontSize: "1.1rem", color: "var(--text-muted, #666)", maxWidth: "600px", margin: "0 auto" }}>
                                ...
                                <div key={event.id} className="col-lg-4 col-md-6 mb-4">
                                    <div
                                        style={{
                                            ...
                                            height: "100%",
                                            border: event.isFeatured ? "2px solid #6432c8" : "1px solid var(--border-color, #eee)",
                                            position: "relative"
                                        }}
                                    >
                                        {event.isFeatured && (
