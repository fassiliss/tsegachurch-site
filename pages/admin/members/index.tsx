...
export default function AdminMembers() {
    ...
    const filteredMembers = members.filter((member) => {
        ...
        return (
            ...
            (member.membershipType && member.membershipType.toLowerCase().includes(query)) ||
            (member.maritalStatus && member.maritalStatus.toLowerCase().includes(query))
        );
    });
            ...
            <main style={{
                ...
                <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "16px", marginBottom: "20px" }} className="no-print">
                    ...
                    🔍
                        ...
                        {searchQuery && (
                            <p style={{ marginBottom: "16px", color: "var(--text-muted)", fontSize: "14px" }} className="no-print">
                                ...
                                <div className="print-area" style={{ overflowX: "auto" }}>
                                    <table style={{ width: "100%", borderCollapse: "collapse" }}>
                                        ...
                                        <tr style={{ borderBottom: "2px solid var(--border-color)" }}>
                                            ...
                                            <th style={{ padding: "12px", textAlign: "left", fontWeight: "600", color: "var(--text-color)" }} className="no-print">Actions</th>
                                        </tr>
                                        </thead>
                                        <tbody>
